...
<body>
    ...
    <div class="formulario mb-4">
        <h3>Digite as informações sobre o depósito</h3>

        <form action="<?= base_url('Home/deposita'); ?>" method="post">
            <div class="form-group">
                ...
                <label for="">Digite o valor do depósito</label>
                <input type="text" class="form-control" name="Deposito">
            </div>
